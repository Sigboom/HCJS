<template>
	<div class="shareFiles row">
		<div class="fileContiner col-sm-8 col-md-8 col-xs-12">
			<p class="showPot col-md-12" v-show="this.$store.state.fileCounter == 0">{{ this.msg }}</p>
			<div class="thumbnail col-md-12"
			@mouseenter="askMenu(id)" @mouseleave="noAskMenu(id)"
			v-for="(file, id) in this.$store.state.fileList" :key="file.id" v-show="!file.filter">
